...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('XRUTZ BOT', {
		font: 'Standard',
	...
	dha.on('connecting', () => {
		console.log(color('[ XRUTZ OFFC ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
