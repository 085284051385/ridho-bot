...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ᴼᶜᴴᴼᴮᴼᵀᶻ☽'//GANTI NAMA KAMU BEP
ban =[]
	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© XrutZ BOT`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ᴼᶜᴴᴼᴮᴼᵀᶻ☽", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Xrutz Bot","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6285284051385`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'ALL MENU'},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: 'RULES BOT'},type:1},{buttonId:`${prefix}store`,buttonText:{displayText:'SIMPEL MENU'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ᴼᶜᴴᴼᴮᴼᵀᶻ☽', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 ᴼᶜᴴᴼᴮᴼᵀᶻ☽' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
...
*iVend :* wa.me/6285284051385`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtli':
              gopeynya = 'https://i.postimg.cc/Dzj553cR/RutzBot.jpg'
              teksnya = `Welcome, Price Role GTLI*
*Link Grup :* 'https://chat.whatsapp.com/C3cIqLN1WNr5XCodBjmDBW'
...
*Chat Owner :* wa.me/6285284051385`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.postimg.cc/Dzj553cR/RutzBot.jpg'
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Suport Script Botz Saya Trus ya\n', imageMessage: imageMsg,
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Xrutz Bot ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/kanti_`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/C3cIqLN1WNr5XCodBjmDBW')
             break
      case 'ownermenu':
