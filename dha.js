...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO BOT","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© XrutZ BOT`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO BOT", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Xrutz Bot","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO BOT' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO BOT`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran OCHOBOTZ 」*\n© RIdhoBotz\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 RIDHO BOT',
			"buttons": [
